...
async function toggleStoryFavorite(evt) {
  ...
  // Given the 25-story limit in our storyList (from our API), a favorited 
  // story from a long time ago may not always exist there, so we'll just 
  // fetch the story directly using this static method.
